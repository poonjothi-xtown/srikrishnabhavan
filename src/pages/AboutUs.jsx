                ...
                <div className="grid md:grid-cols-2 gap-10 items-center p-8 rounded-lg shadow-[0_10px_30px_rgba(0,0,0,0.4)]">
                    ...
                    <div>
                        ...
                        <p className="text-lg mb-4 leading-relaxed text-gray-800">
                            <b>SRI KRISHANA BHAVAN</b> is the beginning of a new culinary journey, created with a passion for <b>authentic South Indian flavors</b>. Though we’ve just started our venture, our goal is to bring <b>freshly prepared, homely dishes</b> straight from our kitchen to your table.
                        </p>
                        <p className="text-lg leading-relaxed text-gray-800">
                            We also take pride in serving <b>bulk orders for festivals, family gatherings, and special occasions</b>, ensuring every meal is cooked with care and delivered with warmth. At <b>sri krishana bhavan</b>, every order is a celebration of <b>taste and tradition</b>.
                        </p>
                    </div>
